        ...
        p-4 gradient-bg-footer">
            ...
            items-center my-4">
                ...
                flex-wrap sm:mt-0 mt-5 w-full">
                    ...
                    <p className="text-white text-base text-center mx-2 cursor-pointer">Tutorialas</p>
                </div>
            </div>
            <div className="flex justify-center items-center flex-col mt-5">
                <p className=" text-white text-sm text-center">Come join us</p>
                <p className=" text-white text-sm text-center">rob@mail.com</p>
            </div>
            <div className="sm:w-[90%] w-full h-[0.25px] bg-gray-400 mt-5" />
            <div className="sm:w-[90%] w-full flex justify-between items-center mt-3">
                <p className=" text-white text-sm text-center">robtov 2022</p>
