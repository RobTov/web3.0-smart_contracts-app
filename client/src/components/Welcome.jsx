...
const Input = ({ placeholder, name, type, value, handleChange }) => (
    <input
        ...
        className="my-2 w-full rounded-small p-2 outline-none bg-transparent
        ...
        <div className="flex w-full justify-center items-center">
            ...
            justify-between md:p-20 py-12 px-4">
                ...
                mf:mr-10">
                    ...
                    py-1  text-white">Send Cryptos <br /> across the world</h1>
                    <p className="text-left mt-5 text-white 
                    font-light md:w-9/12 w-11/12 text-base">Explore the crypto world. Buy and sell cryptocurrencies easy on Krypt</p>
                    {!currentAccount && (
                        <button
                            type="button"
                    ...
                    <div className="flex grid sm:grid-cols-3 grid-cols-2 mt-10">
                        <div className={`rounded-tl-2xl ${commonStyles}`}>
                            Reliability
                        </div>
                        <div className={`${commonStyles} `}>Security</div>
                        <div className={`rounded-tr-2xl sm:rounde-bl-2xl ${commonStyles}`}>
                            Ethereum
                        </div>
                ...
                w-full mf:mt-0 mt-10">
                    ...
                    justify-start items-center blue-glassmorphism">
                        ...
                        name="amount" type="number" handleChange={handleChange}
                        />
                        <Input placeholder="Keyword (Gif)" 
                        name="keyword" type="text" handleChange={handleChange}
                        />
                        <Input placeholder="Enter Message" 
                        name="message" type="text" handleChange={handleChange}
                        />
