        ...
        <nav
         className="w-full flex md:justify-center justify-between items-center p-4">
            ...
            <div className="flex-relative">
                ...
                {toggleMenu && (
                    <ul 
                        className="z-10 fixed top-0 -right-2 p-3 w-[70vw] h-screen shadow-2xl md:hidden list-none flex-col justify-start
                        items-end rounded-md blue-glassmorphism animate-slide-in
                        text-white"
                    >
